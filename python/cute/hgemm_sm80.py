...
bytes_alignment = 16
# PARAMETERS DERIVED -------------------------------------
threads = math.prod(mma_atom_shape) * 32
...
def hgemm_kernel(
    ...
    residual_k = cute.size(A, mode=[1]) - tile_k * cute.size(gA, mode=[2])
...
def hgemm(
    ...
    # * About tiled MMA concepts: https://leimao.github.io/blog/CuTe-Tiled-MMA
